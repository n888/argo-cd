...
type Settings struct {
	...
	ExecTerminalRecordingEnabled bool                               `protobuf:"varint,32,opt,name=execTerminalRecordingEnabled,proto3" json:"execTerminalRecordingEnabled,omitempty"`
	XXX_NoUnkeyedLiteral         struct{}                           `json:"-"`
	XXX_unrecognized             []byte                             `json:"-"`
	XXX_sizecache                int32                              `json:"-"`
}
...
func (m *Settings) GetExecTerminalRecordingEnabled() bool {
	if m != nil {
		return m.ExecTerminalRecordingEnabled
	}
	return false
}
...
var fileDescriptor_a480d494da040caa = []byte{
	...
	,
}
...
func (m *Settings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExecTerminalRecordingEnabled {
		i--
		if m.ExecTerminalRecordingEnabled {
			dAtA[i] = 1
		} else {
...
func (m *Settings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 32:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecTerminalRecordingEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExecTerminalRecordingEnabled = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipSettings(dAtA[iNdEx:])
			if err != nil {
